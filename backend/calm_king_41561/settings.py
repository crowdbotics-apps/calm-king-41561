"""
Django settings for calm_king_41561 project.
...
ROOT_URLCONF = 'calm_king_41561.urls'
...
WSGI_APPLICATION = 'calm_king_41561.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "calm_king_41561 API",
    "DESCRIPTION": "API documentation for calm_king_41561 App",
    "VERSION": "v1",
}
